...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    /**
     * this method works when the dtos get data that is not valid
     * so this method take the errors and return them in the response
     * @param ex
     * @param headers
     * @param status
     * @param request
    ...
    /**
     * This methods works when there is a global exception
     * like runtimeException if not particular exception is found then this
